...
from PySide6.QtWidgets import (
    ...
    QMessageBox, QScrollArea, QSplitter, QFrame, QComboBox
)
...
class AgentsConfigTab(QWidget):
    ...
    def __init__(self, config_manager: ConfigManagement):
        ...
        self.available_tools = ["memory", "clipboard", "code_analysis", "web_search", "spec_validator"]
    ...
    def save_agent(self):
        ...
        # Get selected tools
        tools = [tool for tool, checkbox in self.tool_checkboxes.items() if checkbox.isChecked()]
...
class MCPsConfigTab(QWidget):
    ...
    def save_mcp(self):
        ...
        # Get enabled agents
        enabled_agents = [
            agent for agent, checkbox in self.agent_checkboxes.items() 
        ...
        QMessageBox.information(self, "Success", f"MCP server '{name}' saved successfully.")

...
class ConfigManagement:
    ...
    def update_config(self, new_data: Dict[str, Any], merge: bool = True) -> Dict[str, Any]:
        """
    ...
    def read_agents_config(self) -> Dict[str, Any]:
        ...
        """
        agents_config_path = os.getenv("SW_AGENTS_CONFIG", os.path.expanduser("~/.swissknife/agents.toml"))
        try:
    ...
    def read_mcp_config(self) -> Dict[str, Any]:
        ...
        """
        mcp_config_path = os.getenv("MCP_CONFIG_PATH", os.path.expanduser("~/.swissknife/mcp_server.json"))
        try:
